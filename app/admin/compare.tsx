...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  modalHireBtnText: { color: '#15803D', fontWeight: '700', fontSize: 13 },
  modalRejectBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#FEE2E2', paddingVertical: 10, borderRadius: 8, borderWidth: 1, borderColor: '#FECACA' },
  modalRejectBtnText: { color: '#DC2626', fontWeight: '700', fontSize: 13 },
});
